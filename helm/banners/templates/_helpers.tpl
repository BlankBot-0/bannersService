...
Common labels
*/}}
{{- define "banners.labels" -}}
helm.sh/chart: {{ include "banners.chart" . }}
{{ include "banners.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "banners.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "banners.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "banners.migration-image" -}}
{{- if .Values.skaffold -}}
